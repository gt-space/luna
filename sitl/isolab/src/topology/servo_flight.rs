...
impl ServoFlightLab {
    ...
    pub fn setup(&self) -> Result<()> {
        ...
        self.inner
            .rename_interface(NS_FTEL, "ftel-radio", "radio0")?;
        self.inner
            .rename_interface(NS_GTEL, "gtel-radio", "radio0")?;
    ...
    pub fn cleanup(&self) {
        ...
        self.inner
            .cleanup_namespaces(&[NS_FLIGHT, NS_SERVO, NS_FTEL, NS_GTEL]);
    }
}
