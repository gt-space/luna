...
/// Deals with all communication regarding the Igniter
pub mod igniter;
...
/// Naming conventions for current and voltage
type Current = f64;
type Voltage = f64;
...
pub struct VehicleState {
  ...
  /// Holds the state of device A on Igniter
  pub igniter_a: Igniter,

  /// Holds the state of device B on Igniter
  pub igniter_b: Igniter,
...
impl Default for VehicleState {
  fn default() -> Self {
    Self { 
      ...
      igniter_a: Igniter::default(),
      igniter_b: Igniter::default(),
      gps: None,
      gps_valid: false,
      reco: [None, None, None],
      reco_valid: false,
...
pub enum ADCKind {
  ...
  /// ADCs on the Igniter rev 1 boards.
  IgniterRev1(IgniterRev1ADC),
}
