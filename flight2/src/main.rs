...
fn main() -> ! {
    ...
    loop {
        ...
        let send_umbilical =
            servo_comm_enabled && now.duration_since(last_sent_to_servo) > FC_TO_SERVO_RATE;
...
fn get_servo_data(
    ...
    let servo_disconnect_abort_enabled = devices.servo_disconnect_abort_enabled();
        ...
        Err(e) => {
            ...
            match e {
                ServoError::ServoDisconnected => {
                    if servo_disconnect_abort_enabled {
