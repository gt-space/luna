  ...
  match kind {
    ...
    SamRev4Gnd(rev4_gnd_adc) => {
      match rev4_gnd_adc {
        ...
        SamRev4GndADC::Rtd1 | SamRev4GndADC::Rtd2 | SamRev4GndADC::Rtd3 => ChannelType::Rtd
      }
    },
    ...
    SamRev4Flight(rev4_flight_adc) => {
      match rev4_flight_adc {
        ...
        SamRev4FlightADC::Rtd1 | SamRev4FlightADC::Rtd2 | SamRev4FlightADC::Rtd3 => ChannelType::Rtd
      }
    },
