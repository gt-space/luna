...
arm_status arm_mat_calculate_eigenval_eigenvec(const arm_matrix_instance_f32 *A, arm_matrix_instance_f32 *D, float32_t *D_buff, arm_matrix_instance_f32 *V, float32_t *V_buff, float32_t tolerance, uint32_t maxIter);
