...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB1     ------> ADC2_INP5
    */
    GPIO_InitStruct.Pin = VREF_CH2_DR1_Pin|SNS_2_Pin|SNS_1_Pin|VREF_CH1_DR1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = GPIO_PIN_4|VSNS_3V3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = VREF_CH2_DR2_Pin|VREF_CH1_DR2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC2)
  {
    ...
    PB1     ------> ADC2_INP5
    */
    HAL_GPIO_DeInit(GPIOA, VREF_CH2_DR1_Pin|SNS_2_Pin|SNS_1_Pin|VREF_CH1_DR1_Pin);

    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_4|VSNS_3V3_Pin);

    HAL_GPIO_DeInit(GPIOB, VREF_CH2_DR2_Pin|VREF_CH1_DR2_Pin);
