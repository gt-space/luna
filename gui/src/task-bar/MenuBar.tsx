  ...
  return (
    <div class="menu-bar">
      <div data-tauri-drag-region class="logo">
        <img style="user-select: none" src={logo} width="100" height="70" />
      </div>
      ...
      >
        ...
        <div class="dropdown">
          <div id="dropdowncontent" class="dropdown-content">
            ...
            <div class="dropdown-item">Feedsystem</div>
            <div class="dropdown-item" onClick={() => createPlotterWindow()}>
              Plotter
            </div>
            <div class="dropdown-item">Logs</div>
          </div>
        </div>
      </div>
      <div class="vertical-line"></div>
      <div class="activity-status">
        <div>
          <div class="activity-status-labels">Activity:</div>
          <div class="activity-status-labels">Status:</div>
        </div>
        <div>
