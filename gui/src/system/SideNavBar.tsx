  ...
  return (
    <div class="side-nav-bar">
      <div
        ...
        onClick={() => updateSelection('side-nav-connect')}
      >
        Connect
      </div>
      <div
        id="side-nav-feedsystem"
        class="side-nav-button"
        onClick={() => updateSelection('side-nav-feedsystem')}
      >
        Setup
      </div>
      <div
        id="side-nav-config"
        class="side-nav-button"
        onClick={() => updateSelection('side-nav-config')}
      >
        Config
      </div>
      <div
        id="side-nav-sequences"
        class="side-nav-button"
        onClick={() => updateSelection('side-nav-sequences')}
      >
        Sequences
      </div>
      <div
        id="side-nav-triggers"
        class="side-nav-button"
        onClick={() => updateSelection('side-nav-triggers')}
      >
        Triggers
      </div>
    </div>
