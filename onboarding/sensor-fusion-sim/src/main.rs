...
async fn main() {
    loop {
        ...
        let fuel_pressur_task= task::spawn(sensors::async_pressure_sensor("Fuel Tank Pressure", "psi"));
        ...
        let (engine_temp, lox_temp, fuel_temp, lox_pressure, fuel_pressure, pneumatics, valve_task, _) = 
            join!(
                engine_temp_task,
                lox_temp_task,
                fuel_temp_task,
